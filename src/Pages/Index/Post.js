...
function Post(props) {
  ...
  let color;
  if (user !== null) {
    const userExit = item.like.filter(
  ...
  return (
    <div className="Post">
      ...
      <div className="p-title">
        <h3>
          Tên sản phẩm : <span>{item.title}</span>
        </h3>
        <h3>
      ...
      <div className="p-action">
        <postContext.Consumer>
          {({ likePost }) => (
            ...
            >
              <LikeOutlined style={{ marginRight: "10px", color }} />
              Thích
            </Button>
          )}
        </postContext.Consumer>
        ...
        <tradeContext.Consumer>
          {({
            ...
            <>
              <Button disabled={dissableTrade} onClick={showModal(item)}>
