...
function PostProduct(props) {
    ...
    const { Option } = Select;
    const children = ['Bất động sản','Xe cộ','Đồ điện tử','Thú cưng','Đồ gia dụng','Thời trang'];
                                ...
                                <div className="f-register">
                                    ...
                                    <Form
                                        ...
                                        <Form.Item className="login-btn">
                                            <Button type="primary" loading={loadCreatePost} htmlType="submit" className="login-form-button">
                                                Đăng bài
                                            </Button>
                                        </Form.Item>
                                    </Form>
