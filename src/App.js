          ...
          <div className="App">
            ...
            <Switch>
              <Route path="/post-product">
                <PostProduct
                  // onFinishCreatPost={onFinishCreatPost} 
                  // onChangeFileInput={onChangeFileInput} 
                  // handleChangeCataInput={handleChangeCataInput}
                  // loadCreatePost={loadCreatePost}
                  // fileList={fileList}
                />
              </Route>
              ...
              <Route path="/login" >
                <Login onFinish={onLoginFinish} loginSus={isLogin}  loadLogin={loadLogin} />
              </Route>
              <Route path="/" >
